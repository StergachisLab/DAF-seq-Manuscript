...
HepG2 <- read_tsv('PS00744_HepG2_SLC39A4_map-pb_corrected_realigned_SLC39A4_region_DAF_DeDuplicated_stats_Downsample.tsv')
HepG2$tissue <- 'HepG2_SLC39A4'

merged_all <- rbind(Colon, GM12878, Heart, Liver, NAPA, WASF1, UBA1, COLO, HepG2)
...
HepG2_ALL <- read_tsv('PS00744_HepG2_SLC39A4_map-pb_corrected_realigned_SLC39A4_region_DAF_DeDuplicated_stats.tsv')
HepG2_ALL$tissue <- 'HepG2_SLC39A4'

merged_all2 <- rbind(Colon_ALL, GM12878_ALL, Heart_ALL, Liver_ALL, NAPA_ALL, WASF1_ALL, UBA1_ALL, COLO_ALL, HepG2_ALL)
...
COLO$tissue <- 'COLO829BLT'
HepG2 <- read_tsv('PS00744_HepG2_SLC39A4_map-pb_corrected_realigned_SLC39A4_region_DAF_DeDuplicated_stats_Downsample_highRange.tsv')
HepG2$tissue <- 'HepG2_SLC39A4'
