...
# Liver
samtools fasta test_bams/Liver_SLC39A4_PS00680_haplotype_corrected.bam | bgzip -@ 30 > liver_hap_corrected.fasta.gz
...
# Colon
samtools fasta test_bams/Colon_SLC39A4_PS00682_haplotype_corrected.bam | bgzip -@ 30 > colon_hap_corrected.fasta.gz
...
# Heart
samtools fasta test_bams/Heart_SLC39A4_PS00681_haplotype_corrected.bam | bgzip -@ 30 > heart_hap_corrected.fasta.gz
...
# GM12878 SLC39A4
samtools fasta test_bams/GM12878_SLC39A4_PS00686_haplotype_corrected.bam | bgzip -@ 30 > GM12878_SLC39A4_hap_corrected.fasta.gz
...
# GM12878 WASF1
samtools fasta test_bams/PS00626_map-pb_corrected_realigned_WASF1_region.bam | bgzip -@ 30 > WASF1_realigned.fasta.gz
...
# GM12878 NAPA
samtools fasta test_bams/PS00626_map-pb_corrected_realigned_NAPA_region.bam | bgzip -@ 30 > napa_realigned.fasta.gz
...
# GM12878 UBA1
samtools fasta test_bams/PS00685_GM12878_UBA1_map-pb_corrected_realigned_UBA1_region.bam | bgzip -@ 30 > UBA1_realigned.fasta.gz
...
# COLO829BLT
samtools fasta test_bams/PS00719_COLO_Region2_map-pb_corrected_realigned_COLO_region.bam | bgzip -@ 30 > COLO_realigned.fasta.gz
