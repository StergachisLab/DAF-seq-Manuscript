...
FT='/gscratch/stergachislab/swansoe/miniconda3/bin/ft'

bam_dir = '/mmfs1/gscratch/stergachislab/swansoe/projects/DddA/PCR_Dev/UBA1'
...
#     subprocess.run(shell_command, shell=True, check=True, capture_output=True, text=True)
#     shell_command = f"/gscratch/stergachislab/install_dir/bedGraphToBigWig {nuc_bed.replace('.bed','.bg')} /mmfs1/gscratch/stergachislab/assemblies/hg38.analysisSet.chrom.sizes {nuc_bed.replace('.bed','.bw')}"
#     subprocess.run(shell_command, shell=True, check=True, capture_output=True, text=True)
#     shell_command = f"/gscratch/stergachislab/install_dir/bedGraphToBigWig {small_bed.replace('.bed','.bg')} /mmfs1/gscratch/stergachislab/assemblies/hg38.analysisSet.chrom.sizes {small_bed.replace('.bed','.bw')}"
#     subprocess.run(shell_command, shell=True, check=True, capture_output=True, text=True)
#     shell_command = f"/gscratch/stergachislab/install_dir/bedGraphToBigWig {large_bed.replace('.bed','.bg')} /mmfs1/gscratch/stergachislab/assemblies/hg38.analysisSet.chrom.sizes {large_bed.replace('.bed','.bw')}"
#     subprocess.run(shell_command, shell=True, check=True, capture_output=True, text=True)
...
#     subprocess.run(shell_command, shell=True, check=True, capture_output=True, text=True)
#     shell_command = f"/gscratch/stergachislab/install_dir/bedGraphToBigWig {out_bg} /mmfs1/gscratch/stergachislab/assemblies/hg38.analysisSet.chrom.sizes {out_bg.replace('.bg','.bw')}"
#     subprocess.run(shell_command, shell=True, check=True, capture_output=True, text=True)
