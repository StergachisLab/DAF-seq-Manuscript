...
# Within 250 bp -- TSS coordinates are 20 bp centered on predicted TSS
zcat FIRE-peaks_HG002_noUnreliableCoverage.AutosomesOnly.bed.gz | sort-bed - | bedmap --ec --echo-ref-name --echo-map --skip-unmapped --range 240 - gencodev45_Ensembl_canonical_TSS.bed > FIRE-peak_HG002_noUnrealiableCov_autosome_v45_TSS_bedmap.txt
