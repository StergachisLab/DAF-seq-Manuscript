...
BEDS=$(ls ../msp_analysis/fibertools_msp/*.haplotagged.MSP_BED6_single_150.bed.gz)
...
bedtools genomecov -bg -i DAF_tss_PLUS_2kb_MSPs_FIRE_peaks_all_cells_and_strands.bed -g ../msp_analysis/hg38.analysisSet.chrom.sizes > DAF_tss_PLUS_2kb_MSPs_FIRE_peaks_all_cells_and_strands.bg
...
bedtools genomecov -bg -i DAF_tss_MINUS_2kb_MSPs_FIRE_peaks_all_cells_and_strands.bed -g ../msp_analysis/hg38.analysisSet.chrom.sizes > DAF_tss_MINUS_2kb_MSPs_FIRE_peaks_all_cells_and_strands.bg
...
bedtools genomecov -bg -i DAF_MSPs_FIRE_peaks_2kb_all_cells_and_strands.bed -g ../msp_analysis/hg38.analysisSet.chrom.sizes > DAF_MSPs_FIRE_peaks_2kb_all_cells_and_strands.bg
...
bedtools genomecov -bg -i FS_tss_PLUS_2kb_MSPs_FIRE_peaks_all_cells_and_strands.bed -g ../msp_analysis/hg38.analysisSet.chrom.sizes > FS_tss_PLUS_2kb_MSPs_FIRE_peaks_all_cells_and_strands.bg
...
bedtools genomecov -bg -i FS_tss_MINUS_2kb_MSPs_FIRE_peaks_all_cells_and_strands.bed -g ../msp_analysis/hg38.analysisSet.chrom.sizes > FS_tss_MINUS_2kb_MSPs_FIRE_peaks_all_cells_and_strands.bg
...
bedtools genomecov -bg -i FS_MSPs_FIRE_peaks_2kb_all_cells_and_strands.bed -g ../msp_analysis/hg38.analysisSet.chrom.sizes > FS_MSPs_FIRE_peaks_2kb_all_cells_and_strands.bg
