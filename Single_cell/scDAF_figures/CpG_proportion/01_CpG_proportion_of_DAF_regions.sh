...
bedops --ec --difference ../../msp_analysis/hg38_autosomes.sizes.bed ../../phasing/unreliable_blacklist_highCov_STRAND_ONLY_regions_merged.bed > daf_mappable_regions.bed
bedtools getfasta -fi ../data/hg38.fa -bed daf_mappable_regions.bed -fo daf_mappable_regions.fa
